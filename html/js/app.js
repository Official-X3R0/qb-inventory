    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p style=\"padding-top: .8vh;font-size:11px\"><b>Weight: </b>" + ((itemData.weight * itemData.amount) / 1000).toFixed(1) + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
            );
...
(() => {
    ...
    Inventory.Open = function(data) {
        ...
        $("#char-info-cash").html(
           '<i class="fas fa-wallet" style="color: #492706"></i> <b>Cash:</b>  ' + data.PlayerMoney + ' <i class="fas fa-dollar-sign"></i>'
        );
        $("#char-info-bank").html(
            '<i class="fas fa-piggy-bank" style="color: #0c500a"></i> <b>Bank:</b>  ' + data.PlayerBank + ' <i class="fas fa-dollar-sign"></i>'
        );
        $("#char-info-name").html(
            '<i class="fas fa-user" style="color: #1696b6"></i> <b>' + data.PlayerName + '</b>'
        );
