...
RegisterNetEvent('inventory:client:OpenInventory', function(PlayerAmmo, inventory, other)
    QBCore.Functions.TriggerCallback('inventory:GetPlayerMoney', function(Money)
        QBCore.Functions.TriggerCallback('inventory:GetPlayerBank', function(Bank)
            QBCore.Functions.TriggerCallback('inventory:GetPlayerName', function(Name, LastName)
                QBCore.Functions.TriggerCallback('inventory:GetPlayerFood', function(Hunger, Thirst)
                    ...
                    QBCore.Functions.TriggerCallback('inventory:server:ConvertQuality', function(data)
                        ...
                        SendNUIMessage({
                            ...
                            PlayerHealth = Health,
                            PlayerHunger = string.format(Hunger),
                            PlayerThirst = string.format(Thirst),
                        })
                        inInventory = true
                        end, inventory, other)
                    end
