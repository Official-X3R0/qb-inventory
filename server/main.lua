...
QBCore.Functions.CreateCallback('inventory:GetPlayerMoney', function(source, cb)
	local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('inventory:GetPlayerBank', function(source, cb)
	local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('inventory:GetPlayerName', function(source, cb)
	local Player = QBCore.Functions.GetPlayer(source)
...
QBCore.Functions.CreateCallback('inventory:GetPlayerFood', function(source, cb)
	local Player = QBCore.Functions.GetPlayer(source)
